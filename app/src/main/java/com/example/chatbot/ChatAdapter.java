...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class CenterViewHolder extends RecyclerView.ViewHolder{
        ...
        }//end of CenterViewHOlder

        public void setItem(ChatItem item){
            final String[] tranContent = new String[1];
            contentText.setText(item.getContent()+"\n"+item.getTranContent());
        }//end of setItem
    }//end of centerViewHolder

    public class LeftViewHolder extends RecyclerView.ViewHolder {
        TextView nameText; //이름
        TextView contentText; //내용
        TextView sendTimeText; //시간
    ...
    public class RightViewHolder extends RecyclerView.ViewHolder{
        ...
        public RightViewHolder(View itemView) {
            ...
            contentText = itemView.findViewById(R.id.msg_text);
            sendTimeText = itemView.findViewById(R.id.send_time_text);
        }//end of RightviewHolder 생성

        public void setItem(ChatItem item){
            contentText.setText(item.getContent()+"\n"+item.getTranContent());
            sendTimeText.setText(item.getSendTime());
        }//end of setItem
    }//end of RightViewHolder
    ...
    public class LeftImageViewHolder extends RecyclerView.ViewHolder{
        ...
        public LeftImageViewHolder(View itemView) {
            ...
            sendTimeText = itemView.findViewById(R.id.send_time_text);
        }//end of LeftImageViewHolder자 생성자
        ...
        public void setItem(ChatItem item, Context context){
            ...
            Glide.with(context)
                    .load(item.getContent()+"/n"+item.getTranContent())
                    .apply(RequestOptions.bitmapTransform(option))
                    .into(image);
            nameText.setText(item.getName());
            sendTimeText.setText(item.getSendTime());
        }//end of setItem
    }//end of LeftImageViewHolder
